    ...
    >
      <Clause heading="1. Ownership and reservation of rights">
        <p>
          ...
          evaluation methodology, the scoring prompts and rule sets, the interface design, the
          source code, the copy on this site and all databases of audited products.
        </p>
        <p>
          No licence to any of the above is granted by implication, estoppel or otherwise. Use of
          the service does not transfer any ownership to you.
        </p>
      </Clause>
      ...
      <Clause heading="2. Prohibited copying">
        ...
        <p>
          build, publish or distribute the same or a substantially similar application; replicate
          the P:C ratio, trust score or confidence framework under any name; copy the LabelTruth
      ...
      <Clause heading="3. Enforcement — legal notices">
        <p>
          Where EcoTruth Group identifies an application, service or feature that copies LabelTruth
          or its methodology,{" "}
          <strong>
            legal notices may be sent to the operator, its hosting provider and the app stores
            distributing it
          </strong>
          , and EcoTruth Group may pursue takedown, injunctive relief, damages and account of
          profits in any competent jurisdiction. EcoTruth Group reserves the right to act without
          prior warning where infringement is ongoing.
        </p>
      </Clause>
      ...
      <Clause heading="6. Reporting infringement">
        <p>
          To report copying of LabelTruth, or to request a licence, contact ip@ecotruthgroup.example
          with the URLs, screenshots and a description of the overlap.
        </p>
      </Clause>
    </LegalPage>
  );
