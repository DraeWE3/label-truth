            ...
            <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
              <div>
                ...
                <h1 className="mt-8 max-w-3xl font-display text-6xl font-medium leading-[0.9] sm:text-8xl">
                  Photograph the pack.
                  <span className="text-luxe mt-2 block italic">
                    See if it is telling the truth.
                  </span>
                </h1>
                <p className="mt-8 max-w-xl text-sm leading-relaxed text-primary-foreground/75 sm:text-base">
                  LabelTruth reads the label, judges healthy or not, and scores the gap between what
                  the product actually delivers and what the packaging claims — the{" "}
                ...
                <p className="mt-8 max-w-xl text-xs italic text-primary-foreground/60">
                  {trackedNotice}
                </p>
              </div>
