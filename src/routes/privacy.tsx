  ...
  return (
    ...
    >
      <Clause heading="1. What we collect">
        ...
        <p>
          <strong>Scan history.</strong> Your scan log is written to your own browser storage on
          your device. It is not uploaded to us, and clearing it in the app removes it.
        </p>
        <p>
          <strong>API partner data.</strong> For API Program subscribers we process the partner
          code, request metadata, volumes and billing details needed to run the account.
        </p>
      </Clause>

      <Clause heading="2. What we do not do">
        <p>
          We do not sell personal information. We do not require an account to scan a pack. We do
          not ask for health records, and LabelTruth results are guidance, not medical advice or a
          diagnosis.
        </p>
      </Clause>
      ...
      <Clause heading="3. Third parties">
        <p>
          ...
          Hosting, error reporting and payment processing are also handled by service providers.
          Each receives only what its function requires.
        </p>
      </Clause>

      <Clause heading="4. Retention">
        <p>
          Images submitted for scanning are used only to return your result and are not stored by
          us; our AI provider may process them transiently under its own terms. Your most recent
          scans are kept in your browser on your device until you clear them. Account and billing
          records for API subscribers are kept for as long as the account is active and afterwards
          where law requires.
        </p>
      </Clause>
      ...
      <Clause heading="6. Children">
        <p>
          LabelTruth is not directed at children under 13 and we do not knowingly collect their
          data.
        </p>
      </Clause>
