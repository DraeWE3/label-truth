      ...
      <main>
        ...
        >
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-5 max-w-2xl text-sm leading-relaxed text-primary-foreground/75">
              ...
              display our sponsored placements against a scan, you earn a share of that revenue. API
              access itself is paid — the revenue share offsets it, it does not replace it.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-5 py-14">
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            Illustrative example: endpoint, code and values are placeholders until a sandbox key is
            issued.
          </p>
  ...
  "placement": { "id": "plc_92f", "payout_cents": 4 }
          ...
          <div className="mt-10 rounded-3xl border border-border bg-card p-6 shadow-card">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              TechForges&apos; upcoming nutrition tracking device is the first commercial
              integration of the API Program, streaming scan results straight onto the wearable.
            </p>
            <Link
              to="/"
